...
description: Research conducted with Scientific OS, published with its evidence, reach, limits, and open questions.
lang: en
---

<p class="site-definition">A place to publish research questions pursued with Scientific OS — not only the results, but the evidence behind them, how far the claims reach, and what remains unknown.</p>

<p class="site-boundary">This is not a catalogue of finished work. Studies are at different stages, use different kinds of evidence, and remain open to revision through external reproduction and refutation.</p>
...
<div class="program-index">
  <article class="program-row">
    <div>
      ...
      <p>We construct exact two-class FCFS capacity and integrate information contracts, wrong-side rates and abstention prices into a technical-report draft.</p>
    </div>
    <nav aria-label="GPU cluster scheduling">
      <a href="/en/programs/gpu-scheduling/">Program overview</a>
      <a href="/en/research/gpu-scheduling-two-class-control/">Current Note</a>
    </nav>
  </article>
  <article class="program-row">
    <div>
