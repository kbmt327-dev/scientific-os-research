...
| [[research/gpu-scheduling-starvation-mechanism/index\|Whole-cluster jobs, not mean gang size, decide when size-based scheduling breaks]] | `Finding` · `Synthetic` · `Exploratory` | Mean-matched control separates support from mean; no real trace validation. Graded 7/10. |
