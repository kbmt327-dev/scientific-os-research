...
7. editorial、scientific、domain-expert、peer reviewを分けて記録する。Editorial reviewは科学的妥当性の検証を意味しない。
8. 実siteをbuildし、desktopとmobileで確認する。
9. public repositoryの検査が通った後だけ公開する。
