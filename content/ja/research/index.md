...
**現在地：** 復号はしていません。新しい平文文字は0です。EP-0057は「5つのWのうち2つが公開cribを外側から挟む」という観察を再現しましたが、Wという文字を選ばなければ確率は0.036で、W区間のTOKIO読みとも独立ではありません。Wを空文字・鍵の再始動点・ブロック境界・25文字暗号の素通り記号とみなす読みは、どれも候補を出しませんでした。
