...
def kryptos_k4_57973_audit() -> None:
    root = ROOT / 'reproduction' / 'kryptos-k4-57973-audit'
    print(run([sys.executable, 'verify_57973_audit.py'], root).strip())


def kryptos_k4_tokio_null() -> None:
    root = ROOT / 'reproduction' / 'kryptos-k4-tokio-null'
    print(run([sys.executable, 'verify_tokio_null.py'], root).strip())
